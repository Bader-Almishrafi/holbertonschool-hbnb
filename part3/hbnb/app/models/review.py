...
class ReviewList(Resource):
    ...
    def post(self):
        """Create a review if user does not own the place and has not reviewed it before"""
...
class ReviewResource(Resource):
    ...
    def put(self, review_id):
        """Update a review only if created by authenticated user"""
        current_user_id = get_jwt_identity()
        review = facade.get_review(review_id)
    ...
    def delete(self, review_id):
        """Delete a review only if created by authenticated user"""
        current_user_id = get_jwt_identity()
        review = facade.get_review(review_id)
